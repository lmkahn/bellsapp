		...
		this.createGroupMemberMarker = function(member, symbolUrl){
			if(member.birth_certificate.lat && member.birth_certificate.lon){
				...
				if(member.birth_certificate.lat == "45.42882" && member.birth_certificate.lon == "12.344017"){
					symbolUrl = '../belltower6_red.png';
				}
				//GIOB
				if(member.birth_certificate.lat == "45.444338" && member.birth_certificate.lon == "12.320756"){
					symbolUrl = '../belltower6_red.png';
				}
				//RAFF
				if(member.birth_certificate.lat == "45.431694" && member.birth_certificate.lon == "12.319028"){
					symbolUrl = '../belltower6_red.png';
				}
				//YELLOW = only audio
				//APON
				if(member.birth_certificate.lat == "45.437382" && member.birth_certificate.lon == "12.332519"){
					symbolUrl = '../belltower6_yellow.png';
				}
				//BART
				if(member.birth_certificate.lat == "45.436985" && member.birth_certificate.lon == "12.336573"){
					symbolUrl = '../belltower6_yellow.png';
				}
				//MARC
				if(member.birth_certificate.lat == "45.442295" && member.birth_certificate.lon == "12.329057"){
					symbolUrl = '../belltower6_yellow.png';
				}
				//MICH
				if(member.birth_certificate.lat == "45.448472" && member.birth_certificate.lon == "12.347256"){
					symbolUrl = '../belltower6_yellow.png';
				}
				//SALV
				if(member.birth_certificate.lat == "45.435747" && member.birth_certificate.lon == "12.336898"){
					symbolUrl = '../belltower6_yellow.png';
				}
				//STAE
				if(member.birth_certificate.lat == "45.440576" && member.birth_certificate.lon == "12.330653"){
					symbolUrl = '../belltower6_yellow.png';
				}
				//VIGN
				if(member.birth_certificate.lat == "45.437519" && member.birth_certificate.lon == "12.348848"){
					symbolUrl = '../belltower6_yellow.png';
				}
				//ORANGE = only view
				//DONA
				if(member.birth_certificate.lat == "45.456576" && member.birth_certificate.lon == "12.357145"){
					symbolUrl = '../belltower6_orange.png';
				}
				//FORM
				if(member.birth_certificate.lat == "45.436505" && member.birth_certificate.lon == "12.340979"){
					symbolUrl = '../belltower6_orange.png';
				}
				//FRAR
				if(member.birth_certificate.lat == "45.436005" && member.birth_certificate.lon == "12.326652"){
					symbolUrl = '../belltower6_orange.png';
				}
				//GERE
				if(member.birth_certificate.lat == "45.442238" && member.birth_certificate.lon == "12.325747"){
					symbolUrl = '../belltower6_orange.png';
				}
				//ORTO
				if(member.birth_certificate.lat == "45.446015" && member.birth_certificate.lon == "12.332678"){
					symbolUrl = '../belltower6_orange.png';
				}
				//PIET
				if(member.birth_certificate.lat == "45.433591" && member.birth_certificate.lon == "12.359162"){
					symbolUrl = '../belltower6_orange.png';
				}
				//POLO
				if(member.birth_certificate.lat == "45.436283" && member.birth_certificate.lon == "12.329657"){
					symbolUrl = '../belltower6_orange.png';
				}
